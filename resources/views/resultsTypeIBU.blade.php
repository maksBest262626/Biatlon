...
<div class="row row-cols-1 row-cols-md-1 mb-2 text-center">
      <div class="col">
          ...
          foreach ($types as $type) {
            ...
            if ($type->type == "male10sprint2")  { $russian = "Мужчины. Спринт на 10 км."; } 
            if ($type->type == "female75sprint2")  { $russian = "Женщины. Спринт на 7.5 км."; }
            ...
            if ($type->type == "male15oneGonka")  { $russian = "Мужчины. Индивидуальная гонка на 15 км."; }
            if ($type->type == "female125oneGonka")  { $russian = "Женщины. Индивидуальная гонка на 12.5 км."; }
            if ($type->type == "male20gonka")  { $russian = "Мужчины. Гонка на 20 км."; }  
            echo "
            <br>
            <div class='container text-center' align='center' ><a href='/results/cupOfIBU/{$etap}/{$type->type}' class='btn btn-primary' align=center>
              {$russian}
            </a></div>
            <br><br>";
          }
